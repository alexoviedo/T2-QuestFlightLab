    ...
    public class FlightTelemetry : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Current = new FlightTelemetrySnapshot
            {
                ...
                stallIntensity = aircraftState.stallIntensity,
                slipSkid = aircraftState.slipSkid,
                referenceSpeedKts = aircraftState.referenceSpeedKts,
                targetSpeedErrorKts = aircraftState.targetSpeedErrorKts,
