...
4. Use the v0.7 procedural scenic splat patch as a playable-demo visual option, then capture or source one small owned/licensed SPZ/PLY scenic patch for import/conversion, LOD/chunking/global-budget controls, and repeat Quest runtime timing without making splats required.
