...
4. Turn the v0.6c synthetic Quest splat pass into a real asset-pipeline spike: owned/licensed SPZ/PLY capture, import/conversion, LOD/chunking/global-budget controls, and repeat Quest runtime timing without making splats required.
